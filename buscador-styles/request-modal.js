...
document.addEventListener("DOMContentLoaded", () => {
  ...
  modalStep2Question = document.getElementById("modal-step2-question");
  ...
  nextStepButton.addEventListener("click", () => {
    if (selectedContent) {
      ...
      modalStep2Question.classList.remove("hidden");
  ...
  inAppYesButton.addEventListener("click", () => {
    modalStep2Question.classList.add("hidden");
