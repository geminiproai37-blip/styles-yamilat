...
export async function fetchMovies(apiBaseUrl) {
  try {
...
export async function fetchSpecificMovies(apiBaseUrl, movieData) {
  try {
    ...
    return movies.filter(Boolean); // Filter out null values
  } catch (error) {
