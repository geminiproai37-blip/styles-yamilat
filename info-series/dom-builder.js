...
export async function buildMovieDetailPage(
  ...
  if (movie.genres && movie.genres.length > 0) {
    ...
    genresContainer.className = "flex flex-wrap gap-2 mt-2 md:mt-0 md:ml-4";
  ...
  // Display number of seasons based on localEpisodesDb if available
  if (localEpisodesDb[mediaIdStr]) {
    ...
    if (numberOfLocalSeasons > 0) {
      ...
      seasons.textContent = `${numberOfLocalSeasons} Temporada${
